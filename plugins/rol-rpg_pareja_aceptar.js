...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '🌸 TANI-BOT ', thumbnailUrl: await(await fetch(global.img)).buffer(), sourceUrl: yt }}}
