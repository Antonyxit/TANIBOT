...
let link = 'https://chat.whatsapp.com/' + await conn.groupInviteCode(group)
      ...
      await conn.reply(text+'@s.whatsapp.net', `Hola! me presento, soy TANI BOT , soy un Bot de WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te unas al grupo, te esperamos con ansias!!\n\n${link}`, m, {mentions: [m.sender]})
