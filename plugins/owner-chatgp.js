...
const handler = async (m, {conn, text, groupMetadata}) => {
  ...
  const fakegif = {key: {participant: `0@s.whatsapp.net`, ...('5219941080548-1613049930@g.us' ? {remoteJid: '5219941080548-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': 'TANI BOT', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': 'MonkeyBot', 'jpegThumbnail': false}}};
