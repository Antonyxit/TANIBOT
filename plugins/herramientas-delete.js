...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '🌸 𝙏𝘼𝙉𝙄 𝘽𝙊𝙏 🌸 ', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}}
